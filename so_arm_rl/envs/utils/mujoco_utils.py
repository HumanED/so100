...
def robot_get_obs(model, data, joint_names):
    """Returns all joint positions (Radians) and velocities (Radians per second) associated with joints starting with "robot". All joints in the arm start with robot"""
